...
describe('Game', () => {
    ...
    describe('constructor', () => {
        ...
        it('should create game with custom config', () => {
            ...
            const customGame = new Game_1.Game(customConfig);
    ...
    describe('processAITurn', () => {
        ...
        it('should detect CPU victory when all player ships sunk', () => {
            ...
            // Update game state
            game.gameState.playerShipsRemaining = 0;
            game.gameState.gameResult = 'cpu_win';
            expect(game.isGameOver()).toBe(true);
